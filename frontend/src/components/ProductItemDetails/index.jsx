...
const ProductItemDetails = () => {
  ...
  const getFormattedData = data => ({
    availability: data.availability || "not avaliable",
    brand: data.brand,
  ...
  const getProductData = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log('API Response:', fetchedData); // Log API response
        const updatedData = getFormattedData(fetchedData);
        const updatedSimilarProductsData = Array.isArray(fetchedData.similar_products)
          ? fetchedData.similar_products.map(eachSimilarProduct =>
            ...
            <div className="product-details-container">
              ...
              <div className="product">
                ...
                <button
                  ...
                  onClick={()=>onClickAddToCart(title)}
                >
                  ADD TO CART
                </button>
              </div>
